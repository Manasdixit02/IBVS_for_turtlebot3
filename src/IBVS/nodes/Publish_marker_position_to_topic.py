...
def publish_marker_pose(Camera_pose):
    pub = rospy.Publisher('/Marker_position', Float64MultiArray, queue_size=10)
...
if __name__ == '__main__':
    ...
    values = np.array([0,-3.0,0.0,90.0,0.0,110.0])
    publish_marker_pose(values)
